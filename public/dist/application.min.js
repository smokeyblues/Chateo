...
!function(){"use strict";function AboutController($scope){function init(){}init()}angular.module("core").controller("AboutController",AboutController),AboutController.$inject=["$scope"]}();
!function(){"use strict";function ContactController($scope){function init(){}init()}angular.module("core").controller("ContactController",ContactController),ContactController.$inject=["$scope"]}();
!function(){"use strict";function Googleaab1744130d17c66Controller($scope){function init(){}init()}angular.module("core").controller("Googleaab1744130d17c66Controller",Googleaab1744130d17c66Controller),Googleaab1744130d17c66Controller.$inject=["$scope"]}();
